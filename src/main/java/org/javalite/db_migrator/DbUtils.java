...
import static org.javalite.db_migrator.DatabaseType.DB2;
import static org.javalite.db_migrator.DatabaseType.H2;
import static org.javalite.db_migrator.DatabaseType.HSQL;
import static org.javalite.db_migrator.DatabaseType.MYSQL;
import static org.javalite.db_migrator.DatabaseType.ORACLE;
...
import static org.javalite.db_migrator.DatabaseType.UNKNOWN;
...
public class DbUtils {
  ...
  /**
   * Given a jdbc url, this tries to determine the target database and returns the
   * driver class name as a string.
   *
   * @param url jdbc url
  ...
  public static String extractServerUrl(String url) {
    ...
    // TODO This next line is pretty ugly, but it works for nearly every postgresql
    // server.
    // If we have to add another exception to this for another database server, then
    // I highly recommend refactoring this to a more elegant solution.
