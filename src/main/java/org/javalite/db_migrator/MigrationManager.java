  ...
  public void migrate(String encoding) {
    ...
    try {
      ...
      for (Migration migration : pendingMigrations) {
        ...
        versionStrategy.recordMigration(currentMigration.getVersion(), new Date(start),
      ...
      throw new MigrationException(
          "Migration for version " + currentMigration.getVersion() + " failed, rolling back and terminating migration.",
          e);
    }
